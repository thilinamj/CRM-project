...
$query = "INSERT INTO user(first_name,last_name,email,phone_num,password,position) VALUES('$name','$uname1','$email','$phone','$hashed_password','$position')";
...
<input type="text"  placeholder="Last Name" name="name1" required  />
<br>
